...
namespace RainWorx.FrameWorx.MVC
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/bundles/admin/css/template").Include(
                        "~/Content/css/reset.css",
                        "~/Content/css/Template/001.css"));
            //<!--[if IE 8]>
            //    <link type="text/css" href="Content/css/Template/IE8001.css" rel="stylesheet" />
            //<![endif]-->

            bundles.Add(new StyleBundle("~/bundle/css/demo").Include(
                        "~/Content/css/DemoToolbar.css",
                        "~/Content/css/DemoTour.css"));

            bundles.Add(new ScriptBundle("~/bundles/demojs").Include(
                        "~/Scripts/DemoToolbar.js",
