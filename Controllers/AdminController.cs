...
namespace RainWorx.FrameWorx.MVC.Controllers
{
    ...
    public class AdminController : AuctionWorxController
    {
        ...
        public ActionResult ScheduledPayments()
        {
            ...
            ViewData["BatchTime"] =
                DateTime.Parse(batchPaymentTime.Value).ToString("t", this.GetCultureInfo());
            ...
            if (Request.Form[Strings.MVC.SubmitAction_Save] != null)
            {
                ...
                try
                {
                    if (propertiesToDisplay.Count > 0)
                    {
                        ...
                        {
                            batchPaymentDTTM =
                                DateTime.Parse(input.Items["BatchTime"], this.GetCultureInfo());
                        }
                        catch
                        {
                            //any parse failure:
                        ...
                        input.Items.Add("BatchPaymentTime", batchPaymentDTTM.ToString());
                        ...
                        input.Items.Add("NextBatchPayment", nextBatchTime.ToString());
        ...
        public ActionResult SalesPreferences()
        {
            ...
            ViewData["BatchTime"] = nextSalesBatchPayment.ToString("t", this.GetCultureInfo());
            ...
            if (Request.Form[Strings.MVC.SubmitAction_Save] != null)
            {
                ...
                try
                {
                    if (propertiesToDisplay.Count > 0)
                    {
                        ...
                        try
                        {
                            batchTimeOfDay = DateTime.Parse(input.Items["BatchTime"], this.GetCultureInfo());
                        }
                        catch
                        {
                            //any parse failure:
                        ...
                        input.Items.Add(SiteProperties.AutoChargeCCsTimeOfDay, batchTimeOfDay.ToString());
                        ...
                        input.Items.Add(SiteProperties.NextSalesBatchPaymentDttm, nextBatchDttm.ToString());
                                    ...
                                    string sort, string page, string descending)
        {
            ...
            {
                dateStart = DateTime.Now.AddDays(-90).ToString("d", this.GetCultureInfo());
            }
